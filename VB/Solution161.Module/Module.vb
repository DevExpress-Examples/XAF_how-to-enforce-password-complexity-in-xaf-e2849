...
Namespace Solution161.Module
	Public NotInheritable Partial Class Solution161Module
		...
		Public Sub New()
			InitializeComponent()
		End Sub
		Protected Overrides Sub CustomizeModelApplicationCreatorProperties(ByVal creatorProperties As DevExpress.ExpressApp.Model.Core.ModelApplicationCreatorProperties)
			MyBase.CustomizeModelApplicationCreatorProperties(creatorProperties)
			creatorProperties.RegisterObject(GetType(DevExpress.ExpressApp.Validation.IModelRuleBase), GetType(PasswordStrengthCodeRule), GetType(DevExpress.Persistent.Validation.IRuleBaseProperties))
		End Sub
	...
	Public Class PasswordStrengthCodeRule
		...
		End Sub
		Protected Overrides Overloads Function IsValidInternal(ByVal target As ChangePasswordOnLogonParameters, <System.Runtime.InteropServices.Out()> ByRef errorMessageTemplate As String) As Boolean
