...
namespace Solution161.Module {
    public sealed partial class Solution161Module : ModuleBase {
        ...
        public override void Setup(ApplicationModulesManager moduleManager) {
            ...
            ValidationRulesRegistrator registrator = new ValidationRulesRegistrator(moduleManager);
            registrator.RegisterRule(
                typeof(PasswordStrengthCodeRule),
                typeof(IRuleBaseProperties));
            this.Application.SetupComplete += new EventHandler<EventArgs>(application_SetupComplete);
        }
